...
\begin{document}
		...
		\section{色覚シミュレーションについて}
			...
			\begin{figure}[tbp]
				...
				\begin{tabular}{c}
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=6.5truecm]{D:/a/figs/signal.png}
					\end{minipage}
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=6.5truecm]{D:/a/figs/prot_imagej_100_signal.png}
					\end{minipage} \\
					...
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=6.5truecm]{D:/a/figs/deut_imagej_100_signal.png}
					\end{minipage}
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=6.5truecm]{D:/a/figs/trit_imagej_100_signal.png}
					\end{minipage}
				\end{tabular}
			...
			\begin{figure}[tbp]
				...
				\begin{tabular}{c}
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=7.5truecm]{D:/a/figs/56.PNG}
					\end{minipage}
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=7.5truecm]{D:/a/figs/prot_imagej_100_56.png}
					\end{minipage} \\
					\begin{minipage}{0.06\linewidth}
						\vspace{10truemm}
					\end{minipage} \\
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=7.5truecm]{D:/a/figs/deut_imagej_100_56.png}
					\end{minipage}
					\begin{minipage}{0.5\linewidth}
						\centering
						\includegraphics[width=7.5truecm]{D:/a/figs/trit_imagej_100_56.png}
					\end{minipage}
				\end{tabular}
	...
	\chapter{色空間の歴史と概要}
		...
		\section{等色関数と\mathdisplaystyle{RGB}色空間}
			...
			\end{equation*}
			と表す．
			ここで得られる\mathdisplaystyle{\parentheses{L_R,L_G,L_B}}を改めて\mathdisplaystyle{\parentheses{R,G,B}}と書き換えて得られる色空間を\mathdisplaystyle{RGB}色空間という．
			...
			CIE1931\mathdisplaystyle{XYZ}表色系での\mathdisplaystyle{\anglebrackets{R}}，\mathdisplaystyle{\anglebrackets{G}}，\mathdisplaystyle{\anglebrackets{B}}はそれぞれ\SI{700.0}{nm}，\SI{546.1}{nm}，\SI{435.8}{nm}で定められている．
			Stiles--Burchの等色関数（color maching function）\mathdisplaystyle{\bar{r}\parentheses{\lambda}}，\mathdisplaystyle{\bar{g}\parentheses{\lambda}}，\mathdisplaystyle{\bar{b}\parentheses{\lambda}}（\cite{Stiles1955,Stiles1959}より）を図\Reference{fig:matching}に示す\footnote{Stiles--Burchの等色関数における\mathdisplaystyle{\anglebrackets{R}}，\mathdisplaystyle{\anglebrackets{G}}，\mathdisplaystyle{\anglebrackets{B}}はそれぞれ\SI{648.6}{nm}，\SI{526.4}{nm}，\SI{445.3}{nm}であり，CIE1931\mathdisplaystyle{XYZ}のそれとは異なる．}．
			\figureinput{width=\linewidth}{D:/a/figs/RGBcmf.png}{Stiles--Burchの等色関数}{matching}
			暗い色の線が2\textdegree 視野，明るい色の線が10\textdegree 視野である．
